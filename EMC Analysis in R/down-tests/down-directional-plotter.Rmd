...
# plots each down test's x-comp
ggplot(all_down_data, aes(x = time, y = x_eye)) +
  geom_line(color = "red", linewidth = 1) +
  geom_line(aes(x = time, y = x_orb), color = "blue", linewidth = 1) +
  facet_wrap(~test)

# plots each down test's y-comp
ggplot(all_down_data, aes(x = time, y = y_eye)) +
  geom_line(color = "red", linewidth = 1) +
