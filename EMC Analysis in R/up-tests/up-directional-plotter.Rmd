...
# plots each up test's x-comp
ggplot(all_up_data, aes(x = time, y = x_eye)) +
  geom_line(color = "red", linewidth = 1) +
  geom_line(aes(x = time, y = x_orb), color = "blue", linewidth = 1) +
  facet_wrap(~test)

# plots each up test's y-comp
ggplot(all_up_data, aes(x = time, y = y_eye)) +
  geom_line(color = "red", linewidth = 1) +
